  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="md:text-lg xl:text-xl text-gray-500 mt-4">Whoops, something went wrong on our servers.
          <button className="text-blue-500 hover:text-blue-700 font-bold ml-2"
            onClick={
